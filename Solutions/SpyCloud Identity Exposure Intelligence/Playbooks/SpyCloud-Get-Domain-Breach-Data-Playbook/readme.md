# SpyCloud-Get-Domain-Breach-Data-Playbook

![SpyCloud](images/logo.png)

## Summary

Runs on incident trigger, fetches DNS entities (domains), retrieves breach data from SpyCloud API for each domain, and adds results to incident comments.
