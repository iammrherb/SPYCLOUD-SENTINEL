# SpyCloud-Get-Email-Breach-Data-Playbook

![SpyCloud](images/logo.png)

## Summary

Runs on incident trigger, fetches Account entities (emails), retrieves breach data from SpyCloud API for each email, and adds results to incident comments.
