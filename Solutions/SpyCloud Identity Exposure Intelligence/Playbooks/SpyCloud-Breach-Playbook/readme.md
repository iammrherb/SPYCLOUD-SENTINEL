# SpyCloud-Breach-Playbook

![SpyCloud](images/logo.png)

## Summary

Runs on incident trigger from SpyCloud Breach Rule. Fetches entities from the incident and investigates breach data from SpyCloud API.
