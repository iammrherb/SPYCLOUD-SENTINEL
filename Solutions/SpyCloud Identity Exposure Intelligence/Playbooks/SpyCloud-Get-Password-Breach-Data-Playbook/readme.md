# SpyCloud-Get-Password-Breach-Data-Playbook

![SpyCloud](images/logo.png)

## Summary

Takes a password as input and identifies breach data for that password from SpyCloud API. Results are processed in tabular format for investigation.
