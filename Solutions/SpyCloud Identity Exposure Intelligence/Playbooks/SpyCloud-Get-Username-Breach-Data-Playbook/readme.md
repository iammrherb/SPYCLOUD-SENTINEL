# SpyCloud-Get-Username-Breach-Data-Playbook

![SpyCloud](images/logo.png)

## Summary

Runs on incident trigger, fetches Account entities (usernames), retrieves breach data from SpyCloud API for each username, and adds results to incident comments.
...
5. In Microsoft Sentinel, go to **Automation** > **Create** > **Automation Rule**
6. Set the trigger condition and add this playbook as an action
